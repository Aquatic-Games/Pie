...
public static unsafe partial class ShadercNative
{
    ...
    [DllImport("shaderc_shared", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
    public static extern void shaderc_compile_options_set_source_language([NativeTypeName("shaderc_compile_options_t")] shaderc_compile_options* options, shaderc_source_language lang);
    ...
    [DllImport("shaderc_shared", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
    public static extern void shaderc_compile_options_set_binding_base_for_stage([NativeTypeName("shaderc_compile_options_t")] shaderc_compile_options* options, shaderc_shader_kind shader_kind, shaderc_uniform_kind kind, [NativeTypeName("uint32_t")] uint @base);
    ...
    [DllImport("shaderc_shared", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
    public static extern void shaderc_compile_options_set_hlsl_register_set_and_binding_for_stage([NativeTypeName("shaderc_compile_options_t")] shaderc_compile_options* options, shaderc_shader_kind shader_kind, [NativeTypeName("const char *")] sbyte* reg, [NativeTypeName("const char *")] sbyte* set, [NativeTypeName("const char *")] sbyte* binding);
    ...
    [DllImport("shaderc_shared", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
    public static extern shaderc_compilation_status shaderc_result_get_compilation_status([NativeTypeName("const shaderc_compilation_result_t")] shaderc_compilation_result* param0);
